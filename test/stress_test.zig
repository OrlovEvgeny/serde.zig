...
fn makeWide() WideStruct {
    return .{
        ...
        .f06 = 1.5,  .f07 = -2.5, .f08 = 0.0,
        .f09 = true, .f10 = false,
        .f11 = "hello",           .f12 = "world",
        .f13 = 42,   .f14 = null, .f15 = null,
        .f16 = std.math.maxInt(i64), .f17 = std.math.minInt(i64),
        .f18 = 100,  .f19 = 0,    .f20 = std.math.maxInt(u64),
        .f21 = -1,   .f22 = -256, .f23 = 255,   .f24 = 65535,
        .f25 = 3.14, .f26 = true, .f27 = false,  .f28 = true,
        .f29 = -999, .f30 = 999,
    };
}
...
test "stress: wide struct TOML" {
    ...
    const v = TomlWide{
        .f01 = 1, .f02 = -2, .f03 = 3, .f04 = 4, .f05 = 5,
        .f06 = 1.5, .f09 = true, .f10 = false,
        .f11 = "hello", .f12 = "world",
        .f16 = 123456, .f29 = -999, .f30 = 999,
    };
    const bytes = try serde.toml.toSlice(arena.allocator(), v);

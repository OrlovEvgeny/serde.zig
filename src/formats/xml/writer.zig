...
pub fn writeXmlEscaped(writer: *compat.Writer, value: []const u8) compat.Writer.Error!void {
    var start: usize = 0;
    for (value, 0..) |c, i| {
...
/// Escapes &, <, >, ", '.
pub fn writeXmlAttrEscaped(writer: *compat.Writer, value: []const u8) compat.Writer.Error!void {
